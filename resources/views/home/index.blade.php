...
<head>
            ...
            function (a, b) {
                if (!b.__SV) {
                    ...
                    window.dplus = b,
                        ...
                        c.charset = "utf-8",
                        c.async = !0,
                        c.src = "http://w.cnzz.com/dplus.php?id=1260004087",
    ...
    <script type="text/javascript">
        _atrk_opts = {
            ...
            domain: "http://www.kdnet.net/kdnet.net",
            dynamic: true
        };
        (function () {
...
<script type="text/javascript">
    !function () {
            if (location.host == 'http://www.kdnet.net/uc.kdnet.net') {
    ...
    !
        function () {
            require("home:widget/header/header.js").init();
        }();
    !
        function () {
            require("home:widget/shortcut/shortcut.js").init();
        }();
    !
        function () {
            require("home:static/util/hindex.js");
        }();
</script>
