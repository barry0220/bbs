    ...
    <div class="n_gb_c clearfix">
        <div class="lf">
            ...
            <div class="detailed-more-cont" style="display: block;">
                <div class="detailed clearfix">
                    <div class="detailed-info">
                        Email：{{session('homeuser')->email}}<a title=""></a>
                    </div>
                    <div class="operating c-main">
                        <a href="javascript:;" onclick="usercheckemail()" >验证</a>
                    </div>
                </div>
                <div class="detailed clearfix">
                ...
                <form action="{{url('/home/updateuserinfo')}}" method="post" id="detailsform">
                    <div style="height:600px">
                        <div class="control-cont clearfix">
                            ...
                            <div align="center">
                                <div class="btn-controlpanel"><a href="javascript:;" onclick="updateuserinfo()">保存</a></div>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <form action="/home/repass" id="repassform" method="POST">
                    ...
                    <div class="gb-lb" id="cPassword">
                        <div class="control-cont clearfix">
                            ...
                            <div class="btn-controlpanel"><a href="javascript:;" onclick="repass()">保存</a></div>
                        </div>
                    </div>
                </form>
            </div>
                        ...
                        <div class="control-cont clearfix">
                            <div class="cpassword-box">
                                <div class="cforminput clearfix">
                                    ...
                                    <div class="cformfieldtext">
                                        <input name="checkemail" type="text" class="input-boder" style="width:200px" id="checkemail" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="btn-controlpanel">
                                <a href="javascript:;" style="pandding-top:12px;" >验证邮箱</a>
                            </div>
                        </div>
                        <div class="fillinfo">
                 ...
                 <form action="" method="post" id="userfaceform">
                     <div style="height:600px">
                         <div class="control-cont clearfix">
                             ...
                             <div class="btn-controlpanel">
                                     <a href="javascript:;" onclick="updateface()">上传头像</a>
                             </div>
                         </div>
                     </div>
                 </form>
