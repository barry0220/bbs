...
*/
    ...
    'upload' => [
        ...
        "imageUrlPrefix" => "http://oss-cn-beijing-internal.aliyuncs.com", /* 图片访问路径前缀 */
        ...
        "scrawlUrlPrefix" => "http://oss-cn-beijing-internal.aliyuncs.com", /* 图片访问路径前缀 */
        "scrawlInsertAlign" => "none",

        /* 截图工具上传 */
        "snapscreenActionName" => "uploadimage", /* 执行上传截图的action名称 */
        "snapscreenPathFormat" => "/uploads/ueditor/php/upload/image/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        "snapscreenUrlPrefix" => "http://oss-cn-beijing-internal.aliyuncs.com", /* 图片访问路径前缀 */
        ...
        "catcherUrlPrefix" => "http://oss-cn-beijing-internal.aliyuncs.com", /* 图片访问路径前缀 */
        ...
        "videoUrlPrefix" => "http://oss-cn-beijing-internal.aliyuncs.com", /* 视频访问路径前缀 */
        ...
        "fileUrlPrefix" => "http://oss-cn-beijing-internal.aliyuncs.com", /* 文件访问路径前缀 */
        ...
        "imageManagerUrlPrefix" => "http://oss-cn-beijing-internal.aliyuncs.com", /* 图片访问路径前缀 */
        ...
        "fileManagerUrlPrefix" => "http://oss-cn-beijing-internal.aliyuncs.com", /* 文件访问路径前缀 */
